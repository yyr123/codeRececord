...
先叙述下概念😄： 用基础 Vue 构造器，创建一个“子类”。参数是一个包含组件选项的对象。<br>[详情见官网](https://cn.vuejs.org/v2/api/#Vue-extend)。<br>[完整代码地址](https://github.com/hz199/__/blob/master/html/vue/vue.extend%E7%BB%84%E4%BB%B6.html)
:::
